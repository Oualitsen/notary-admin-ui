...
class _FilesService implements FilesService {
  ...
  Future<String> loadFileDocuments(
    ...
    final _result = await _dio.fetch<String>(_setStreamType<String>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/admin/files/load/${filesId}/${partId}/${docId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<int> countBySpecificationName(name) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<int> countByNumber(number) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<int> countByCustomerName(name) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'name': name};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
